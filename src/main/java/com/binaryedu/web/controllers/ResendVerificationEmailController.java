...
public class ResendVerificationEmailController extends SimpleFormController
{
	...
	public ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors)
	{
		...
		try
		{
			ServiceManager.getAccountService().resendVerificationEmail(emailForm.getEmail());
		}
